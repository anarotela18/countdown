...
if (isset($_POST['submit'])) {
    ...
    if (!$_POST['email']) {
        $emailError = '<div class="text-danger"><i class="fa fa-exclamation-triangle"></i>&nbsp;Please enter a validate email</div>';
    }

    if (!$emailError) {
        if (mail($to, $subject, $body, $from)) {
            $result = '<div class="text-success"> <i class="fa fa-check"></i>&nbsp;Thank you well keep you updated</div>';
        } else {
            $result = '<div class="text-danger"><i class="fa fa-exclamation-triangle"></i>&nbsp;Sorry there has been an error, please try again</div>';
        }
    }
}
?>
...
<head>
    ...
    <script src="https://kit.fontawesome.com/bc903b1abd.js" crossorigin="anonymous"></script>
...
<body>
    ...
    <script>
        $(function() {
            $('.countdown').countdown({
                date: "September 30, 2021 15:03:26"
            });
        });
    </script>
